<?php
/**
 * Widget API: Wpsite_Widget_Subscribe
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Wpsite_Widget_Subscribe extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <form>
            ...
            <div class="search_btn-3">
                <button class="btn btn-default" type="submit">  <?php esc_html_e('Subscribe') ?></button>
            </div>
        </form>
        <?php
